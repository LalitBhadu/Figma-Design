...
function Login() {
  return (
    <>
      ...
      <div className="login">
        <div className="line">
          <img src="Ellipse 7.png" alt="" className="ellipse" />
          <span>
            <strong>Neha Bhat</strong>
          </span>
          <div className="icon">
            <svg
            ...
            <span className="icon-name">Queries</span>
          </div>
          <div className="icon-2">
            ...
            <span className="icon-name">Schedules</span>
            <br></br>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="26"
          ...
          <div className="icon-3">
            ...
            <span className="icon-name">Booking & Earn</span>
            <br></br>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="22"
            ...
            <span className="icon-name">Rewards</span>
            <br></br>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
